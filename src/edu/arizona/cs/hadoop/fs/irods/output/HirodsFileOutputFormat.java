...
public abstract class HirodsFileOutputFormat<K, V> extends OutputFormat<K, V> {
    ...
    protected static final String BASE_OUTPUT_NAME = "edu.arizona.cs.hadoop.fs.irods.mapreduce.output.basename";
    ...
    public static void setCompressOutput(Job job, boolean compress) {
        job.getConfiguration().setBoolean("edu.arizona.cs.hadoop.fs.irods.mapred.output.compress", compress);
    }
    ...
    public static void setOutputCompressorClass(Job job, Class<? extends CompressionCodec> codecClass) {
        ...
        job.getConfiguration().setClass("edu.arizona.cs.hadoop.fs.irods.mapred.output.compression.codec",
                codecClass,
    ...
    public static void setOutputPath(Job job, Path outputDir) {
        job.getConfiguration().set("edu.arizona.cs.hadoop.fs.irods.mapred.output.dir", outputDir.toString());
    }

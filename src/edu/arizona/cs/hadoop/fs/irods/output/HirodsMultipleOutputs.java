 ...
 * </pre>
 */
public class HirodsMultipleOutputs<KEYOUT, VALUEOUT> {

    private static final String MULTIPLE_OUTPUTS = "edu.arizona.cs.hadoop.fs.irods.mapreduce.multipleoutputs";

    private static final String MO_PREFIX = "edu.arizona.cs.hadoop.fs.irods.mapreduce.multipleoutputs.namedOutput.";

    private static final String FORMAT = ".format";
    private static final String KEY = ".key";
    private static final String VALUE = ".value";
    private static final String COUNTERS_ENABLED = "edu.arizona.cs.hadoop.fs.irods.mapreduce.multipleoutputs.counters";

    /**
     * Counters group used by the counters of HirodsMultipleOutputs.
     */
    private static final String COUNTERS_GROUP = HirodsMultipleOutputs.class.getName();
    ...
    private static void checkBaseOutputPath(String outputPath) {
        if (outputPath.equals(HirodsFileOutputFormat.PART)) {
     ...
     * numbers only, cannot be the word 'part' as that is reserved for the
     * default output.
     ...
     */
    public HirodsMultipleOutputs(TaskInputOutputContext<?, ?, KEYOUT, VALUEOUT> context) {
        this.context = context;
        namedOutputs = Collections.unmodifiableSet(new HashSet<String>(HirodsMultipleOutputs.getNamedOutputsList(context)));

package edu.arizona.cs.irods_hdfs.hadoop.hdfs;

import edu.arizona.cs.irods_hdfs.hadoop.util.IrodsHdfsConfigUtil;
...
public class IrodsHdfsFileSystem extends FileSystem {
    ...
    private IRODSFile makeIrodsPath(Path path) throws IOException {
        ...
        return createIrodsPath(absolutePath.toString());
    ...
    private IRODSFile createIrodsPath(String path) throws IOException {
        try {
            ...
            throw new IOException("Cannot make IRODSFile from path (" + path + ")");
        }
    }
